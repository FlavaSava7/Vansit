            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                ...
                }else
                {
                    ...
                    if(toAdd)
                    {
                        ...
                        Util.makeToast(getApplication(),getString(R.string.more_offer_information_addedFav_success));
                    }
                    else
                    {
                        Util.makeToast(getApplication(),getString(R.string.more_offer_information_addedFav_fail));
                    }
