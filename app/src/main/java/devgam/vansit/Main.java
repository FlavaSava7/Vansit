...
public class Main extends Fragment implements View.OnClickListener{
    ...
    public void onResume() {
        ...
        rsp = new recommendedSharedPref(getActivity());
        ...
        spinnerCity.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener()
        {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id)
            {
                   ...
                   if (stopAutoFiringCode) {
                       whichCity = parent.getSelectedItem().toString();
                       //newChangeListItems(Util.CITY, spinnerCity.getSelectedItem().toString());
                       ChangeListItems();
        ...
        spinnerType.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener()
        {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id)
            {
                    ...
                    if (stopAutoFiringCode) {
                        whichType = parent.getSelectedItem().toString();
                        //newChangeListItems(Util.RDB_TYPE, spinnerType.getSelectedItem().toString());
                        ChangeListItems();
                    }

                    stopAutoFiringCode = true;
                //rsp.adddToFavType(parent.getSelectedItem().toString());
            }
    ...
    public void newChangeListItems(final String about,final String selection){
        ...
        ValueEventListener QVEL= new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                    for (DataSnapshot areaSnapshot : dataSnapshot.getChildren()) {
                        ...
                        if (tempOffer.getCity().equals(selection)) {
                            tempOffer.setOfferKey(areaSnapshot.getKey());
                            offerList.add(tempOffer);
                        }

                        if (tempOffer.getType().equals(selection)) {
                            tempOffer.setOfferKey(areaSnapshot.getKey());
                            offerList.add(tempOffer);
                        }
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot areaSnapshot: dataSnapshot.getChildren()) {
                    ...
                    tempOffer.setOfferKey(areaSnapshot.getKey());
                        ...
                        if (!tempOffer.getType().equals(whichType))
                            continue;
